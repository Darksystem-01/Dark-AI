...
function formatContent(text) {
    ...
    html = html.replace(imgRegex, (match, prompt) => {
        ...
        return `<img src="https://image.pollinations.ai/prompt/${safePrompt}?width=800&height=800&nologo=true" alt="${prompt}" loading="lazy" class="generated-image" />`;
    });
...
async function sendMessage() {
    ...
    try {
        ...
        while (true) {
            ...
            // Backend is now sending pure text, no need to parse SSE JSON!
